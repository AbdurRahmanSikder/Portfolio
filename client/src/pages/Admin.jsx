...
const Admin = () => {
    ...
    const sidebarLinks = [
        { name: "Add Project", path: "/admin", icon: dashboardicon },
        { name: "Project List", path: "/admin/projectlist", icon: overviewicon },
    ];
                ...
                <div className="md:w-64 w-16 border-r h-[95vh] text-base border-white pt-4 flex flex-col">
                    {sidebarLinks.map((item, index) => (
                        <NavLink
                            ...
                            ${isActive ? "border-r-4 md:border-r-[6px]  border-indigo-500 text-indigo-500"
