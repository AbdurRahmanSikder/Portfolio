  ...
  return (
    <div className='Home'>
      <div className="details">
        ...
        <div className="article">Hi, I’m a full-stack web developer specializing in the MERN stack with a strong foundation in problem-solving and algorithmic thinking.</div>
      </div>
